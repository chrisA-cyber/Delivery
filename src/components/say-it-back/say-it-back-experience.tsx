...
import { ArrowLeft, ArrowRight, AudioLines, Check, Clapperboard, Clock3, Copy, ExternalLink, Film, Headphones, Link2, LoaderCircle, LockKeyhole, Mic, Play, Plus, RotateCcw, ShieldCheck, Sparkles, Square, Trophy, Users, X } from "lucide-react";
          ...
          <section className="say-recorder min-w-0 rounded-2xl border border-white/15 bg-surface p-3 sm:p-4" aria-label="Recording controls">
            ...
            {(editing || captureBusy) && <>
              ...
              <div className="say-active-cue mb-3 rounded-xl border border-acid/25 bg-acid/[0.06] px-3 py-3" aria-label="Current line">
                ...
                <p className="say-cue-text text-lg font-bold leading-snug sm:text-xl">{recordingMode === "lines" ? focusedWindow?.cue.text : sceneCue?.text}</p>
              </div>
