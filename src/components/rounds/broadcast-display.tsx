...
export function BroadcastDisplay({ token }: { token: string }) {
  ...
  return <main className="min-h-screen bg-ink p-[3vw] text-paper" aria-label="Read-only broadcast display">
