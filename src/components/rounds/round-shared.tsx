...
export function AssignmentCard({ assignment, compact = false }: { assignment: GroupAssignment; compact?: boolean }) {
  return <section className="overflow-hidden rounded-2xl border border-white/15 bg-surface">
