...
export async function POST(request: Request) {
  ...
  try {
    ...
    const paths = deliveryRows.flatMap((delivery) => typeof delivery.recording_path === "string" && isOwnerStoragePath(delivery.recording_path, user.id) ? [delivery.recording_path] : []);
