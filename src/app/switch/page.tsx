...
export const metadata: Metadata = { title: "Switch · One phrase. Keep switching.", description: "Repeat the same phrase with emoji emotions or changing speeds. Eight Switch challenges, solo or with friends. Microphone only." };
